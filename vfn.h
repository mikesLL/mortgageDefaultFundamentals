...
public:
	...
	vector<vector<vector<vector<int>>>> xt_grid;
	vector<vector<vector<vector<double>>>> x1_grid, x2_grid, x3_grid, x4_grid, x5_grid; // control variables
	vector<vector<vector<vector<double>>>> vw3_grid;                                    // value function
