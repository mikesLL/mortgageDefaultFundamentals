...
public:
	...
	vector<vector<vector<vector<vector<int>>>>> xt_grid;
	vector<vector<vector<vector<vector<double>>>>> x1_grid, x2_grid, x3_grid, x4_grid, x5_grid; // control variables
	vector<vector<vector<vector<vector<double>>>>> vw3_grid;                                    // value function
	...
	void get_pol(int i_t_in, int i_rm_in, int i_am_in, int i_s_in, int i_w_in, vector<double> &x_pol);

	void set_pol_ten_v(int i_t_in, int i_rm_in, int i_am_in, int i_s_in, int i_w_in, vector<double> &x_pol, int t_i2_in, double v0_in);
	
	eval_res eval_v(int i_t_in, int i_rm_in, int i_am_in, int i_s_in, double w_in);
	...
	void interp_vw3(int i_t_in, int i_rm_in, int i_am_in, int i_s_in);
	
	void clean_vw3_grid(int i_t_in, int i_rm_in, int i_am_in, int i_s_in);

	double get_h_step(int i_t_in, int i_rm_in, int i_am_in, int i_s_in, int w_i_in );
};
