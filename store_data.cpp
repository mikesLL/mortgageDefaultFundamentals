				...
				for (i_rent = 0; i_rent < n_rent; i_rent++) {
					for (i_yi = 0; i_yi < n_yi; i_yi++) {
						...
						*/
						// MODS HERE					
						v1_file << (*vfnt).w_grid[w_i] << ","
							<< (*vfnt).x1_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << "," << (*vfnt).x2_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << "," << (*vfnt).x3_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << ","
							<< (*vfnt).x4_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << "," << (*vfnt).x5_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << "," << (*vfnt).xt_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << ","
							<< (*vfnt).vw3_grid[t_i][i_rm][i_am][i_dm][i_s][w_i] << ",";
						/**/
					}
				}
			}
