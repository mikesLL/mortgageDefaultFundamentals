...
vector<double> gen_x0_con(double coh_in, double b_min, void *vf1_in, void *vf2_in, void *ufnEV21_in, vector<double> x0_in) {
	...
	// check if b_min constraint binds
	if (x0[1] < b_min) {
		opt_flag = 1;
	}
	//else {
